...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.ProfileType}.
 */
@RestController
@RequestMapping("/api")
public class ProfileTypeResource {
    ...
    public ResponseEntity<List<ProfileTypeDTO>> getAllProfileTypes(Pageable pageable) {
        log.debug("REST request to get a page of ProfileTypes");
        Page<ProfileTypeDTO> page = profileTypeService.findAll(pageable);

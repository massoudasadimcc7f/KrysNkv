...
import { ProfileTypeComponent } from 'app/entities/profile-type/profile-type.component';
...
describe('Component Tests', () => {
  describe('ProfileType Management Component', () => {
    let comp: ProfileTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProfileTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.profileTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
